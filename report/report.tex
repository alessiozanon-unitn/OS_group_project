...
\subsection{Testing}
For testing we used the Unity library, which lets you create test functions that check memory with TEST\_ASSERT. We created a test function for kitchen and resource loading that use a test data folder. There is also one to test an unsatisfied customer and the relative change in score.
